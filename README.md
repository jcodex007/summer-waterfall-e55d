...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/summer-waterfall-e55d)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/summer-waterfall-e55d
```

A live public deployment of this template is available at [https://summer-waterfall-e55d.templates.workers.dev](https://summer-waterfall-e55d.templates.workers.dev)
